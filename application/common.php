...
function sendEmail($to,$title,$content){
    ...
    $pm->Username = '18377618028'; // 登录SMTP服务器的用户名，邮箱@前面一串字符
    $pm->Password = 'admin88'; //授权码 登录SMTP服务器的密码

    // 发件人信息
    $pm->From = '18377618028@163.com'; //自己的邮箱
    $pm->FromName = 'kefira'; // 发件人昵称，名字可以随便取
    // 循环设置收件人信息
    foreach($to as $email){
...
//    $accountSid= '8aaf07085c1ab70d015c28adee3d02c3';
    $accountSid= '8a216da864efb1390164f1434ff600c7';
    //主帐号令牌,对应官网开发者主账号下的 AUTH TOKEN
//    $accountToken= '817585a4a0d14f15a0dcd7ab8c534856';
    $accountToken= 'b1003fe61bc542d7bedb8bc2481f1ae1';
    //应用Id，在官网应用列表中点击应用，对应应用详情中的APP ID
    //在开发调试的时候，可以使用官网自动为您分配的测试Demo的APP ID
//    $appId='8aaf07085c1ab70d015c28adefcb02ca';
    $appId='8a216da864efb1390164f143506200ce';
    //请求地址
